...
public:
    ...
    void appendStoreToBlock(TR::SymbolReference *storeSymRef, TR::SymbolReference *loadSymRef, TR::Block *block,
        TR::Node *node);
    void prependStoreToBlock(TR::SymbolReference *storeSymRef, TR::SymbolReference *loadSymRef, TR::Block *block,
        TR::Node *node);
...
private:
    ...
    virtual void markAutosUsedIn(TR::Node *, TR::Node *, TR::Node *, TR::Node **, TR::Block *, List<TR::Block> *,
        vcount_t, int32_t, SymRefCandidateMap &, TR_BitVector *, TR_BitVector *, bool);
    ...
    virtual void transformNode(TR::Node *, TR::Node *, int32_t, TR::TreeTop *, TR::Block *&,
        TR_Array<TR::GlobalRegister> &, TR_NodeMappings *);
    ...
    virtual bool registerIsLiveAcrossEdge(TR::TreeTop *, TR::Node *, TR::Block *, TR::GlobalRegister *, TR::Block *&,
        int32_t);
...
protected:
    ...
    void transformMultiWayBranch(TR::TreeTop *, TR::Node *, TR::Block *, TR_Array<TR::GlobalRegister> &,
        bool regStarTransformDone = false);
    ...
    void addStoresForCatchBlockLoads(TR::TreeTop *appendPoint, TR_Array<TR::GlobalRegister> &extBlockRegisters,
        TR::Block *throwingBlock);
    bool isNodeAvailable(TR::Node *node);
    TR::GlobalRegister *getGlobalRegister(TR::Symbol *, TR_Array<TR::GlobalRegister> &, TR::Block *);
    TR::GlobalRegister *getGlobalRegisterWithoutChangingCurrentCandidate(TR::Symbol *, TR_Array<TR::GlobalRegister> &,
        TR::Block *);
