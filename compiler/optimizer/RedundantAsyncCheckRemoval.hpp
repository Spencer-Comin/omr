...
private:
    ...
    bool isRecognizableExitEdge(TR::CFGEdge *edge, TR::ILOpCodes *op, TR::SymbolReference **ref,
        TR_ProgressionKind *kind, int64_t *limit);
    ...
    EntryInfo *getEntryValue(TR::Block *block, TR::SymbolReference *symRef, TR_BitVector &nodesDone,
...
private:
    ...
    void getNearestAncestors(TR_StructureSubGraphNode *node, TR_StructureSubGraphNode *current,
